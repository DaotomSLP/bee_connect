                ...
                <div class="col-6">
                    <div class="card card-stats">
                        <div class="card-header card-header-info card-header-icon">
                            ...
                            <p class="card-category">{{ Auth::user()->is_admin != 1 ? 'ສ່ວນແບ່ງຂອງສາຂາ' : 'ສ່ວນແບ່ງ' }}</p>
                            <h5 class="card-title">{{ $branch_money }} &#8365;</h5>
                        </div>
                        <div class="card-footer">
                    ...
                    <div class="card card-stats">
                        <div class="card-header card-header-success card-header-icon">
                            ...
                            <p class="card-category">
                                {{ Auth::user()->is_admin != 1 ? 'ຈຳນວນເຄື່ອງທີ່ສົ່ງສຳເລັດແລ້ວ' : 'ຈຳນວນເຄື່ອງທີ່ສົ່ງສຳເລັດທັງໝົດ' }}
                            </p>
                ...
                <div class="col-6">
                    <div class="card card-stats">
                        <div class="card-header card-header-primary card-header-icon">
                            ...
                            <p class="card-category">
                                {{ Auth::user()->is_admin != 1 ? 'ຈຳນວນເຄື່ອງທີ່ກຳລັງສົ່ງໄປ' : 'ຈຳນວນເຄື່ອງທີ່ກຳລັງສົ່ງທັງໝົດ' }}
                            </p>
                    ...
                    <div class="col-6">
                        <div class="card card-stats">
                            <div class="card-header card-header-success card-header-icon">
                                ...
                                <p class="card-category">ຈຳນວນເຄື່ອງທີ່ລູກຄ້າມາເອົາແລ້ວ</p>
                                <h3 class="card-title">{{ $sum_success }}</h3>
                            </div>
                            <div class="card-footer">
