...
@section('body')
                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="row my-3">
                                <div class="col-6">
                                    ...
                                    <div class="form-group"><input type="number" class="form-control form-control-sm"
                                            name="discount" id="discount_input" onkeypress="disableSubmit()">
                                    </div>
                                </div>
                            </div>
                            <div class="row my-3">
                            ...
                            <div>
                                <button type="button" onclick="handleSave()" id="submitBtn" disabled
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="row my-3">
                                <div class="col">
                                    <p class="d-inline pr-3 h5">ລວມເປັນເງິນ : </p>
                                    <p class="d-inline h5" id="total_for_rider">0 ກີບ</p>
                                </div>
                            </div>
    ...
    <script>
        ...
        function calcurateTotalForRider() {
            ...
            $("#total_for_rider").html(`${grandTotal} ກີບ`)
