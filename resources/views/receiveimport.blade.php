            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="/receiveImportProduct">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" action="/receiveImport">
                                {{-- @csrf --}}
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="select_branch" name="send_branch">
                                                ...
                                                @foreach ($branchs as $branch)
                                                    <option
                                                        {{ Request::input('send_branch') == $branch->id ? 'selected' : '' }}
                                                        value="{{ $branch->id }}">
                                                        {{ $branch->branch_name }}
                                                    </option>
                                                @endforeach
                    ...
                    @for ($i = $pagination['offset'] - 4; $i <= $pagination['offset'] + 4 && $i <= $pagination['offsets']; $i++)
                        @if ($i > 1 && $i <= $pagination['all'])
                            <li class="page-item {{ $pagination['offset'] == $i ? 'active' : '' }}">
                                <a class="page-link"
                                    href="{{ Request::route()->getName() }}?id={{ Request::input('id') }}&status={{ Request::input('status') }}&send_branch={{ Request::input('send_branch') }}&receive_date={{ Request::input('receive_date') }}&page={{ $i }}">{{ $i }}</a>
                            </li>
                        @else
