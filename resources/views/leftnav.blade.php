            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    @elseif(Auth::user()->is_admin == 1 && Auth::user()->is_thai_admin != 'yes')
                        ...
                        @elseif(Auth::user()->is_admin_th != 1 )
                            {{-- for Admin --}}
                            {{-- in-house --}}
                            <li><a><i class="fa fa-home"></i> ພາຍໃນ <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li
                                        class="{{ Request::is('send') || Request::is('send/*') ? 'current-page' : '' }}">
                            ...
                            {{-- setting --}}
                            <li><a><i class="fa fa-desktop"></i> ຕັ້ງຄ່າລະບົບ <span
                                        class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li
